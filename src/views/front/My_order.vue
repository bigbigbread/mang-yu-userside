<template>
	<div style="margin-top: 20px;">
		...
		<div v-else style="margin: 0 auto;width: 90%;max-width: 600px;">
			<el-tabs v-model="activeName" type="border-card">
			    <el-tab-pane label="我的购买" name="first">
					<div style="display: flex;align-items: center;justify-content: center;padding-top: 20px;">
						<el-input style="width: 100%;" clearable size="small" placeholder="请输入订单号" v-model="oid"
							class="input-with-select">
							<el-button slot="append" icon="el-icon-search" @click="load1"></el-button>
						</el-input>
					</div>
					<el-row style="margin: 0 auto;padding-top: 20px;padding-bottom: 40px;">
						...
						<el-card v-for="order_list in order_list" :key="order_list.oid" shadow="hover"
							style="cursor: pointer;margin-bottom: 15px;border-radius: 10px;"
							@click.native="order_details(order_list.oid)">
							<div style="display: flex;flex-direction: column;">
								<el-image v-if="order_list.gphoto" :src="order_list.gphoto" style="width: 100%;border-radius: 7px;">
									<div slot="error">
								...
								<div style="padding: 10px;width: 100%;display: flex;flex-direction: column;">
									...
									<span style="margin-top: 8px;">订单号：{{order_list.oid}}</span>
									<span style="margin-top: 14px;">{{order_list.otime}}</span>
								</div>
								<div style="padding: 10px;width: 100%;">
									...
									<div style="display: flex;flex-direction: column;">
										...
										<el-button type="text" style="text-align: right;margin-top: 32px;">
			    ...
			    <el-tab-pane label="我的售出" name="second">
					<div style="display: flex;align-items: center;justify-content: center;padding-top: 20px;">
						<el-input style="width: 100%;" clearable size="small" placeholder="请输入订单号" v-model="oid2"
							class="input-with-select">
					...
					<el-row style="margin: 0 auto;padding-top: 20px;padding-bottom: 40px;">
						...
						<el-card v-for="order_list2 in order_list2" :key="order_list2.oid" shadow="hover"
							...
							<div style="display: flex;flex-direction: column;">
								<el-image v-if="order_list2.gphoto" :src="order_list2.gphoto" style="width: 100%;border-radius: 7px;">
									<div slot="error">
										<img src="../../assets/none.jpg" style="width: 100%;" />
									</div>
								</el-image>
								...
								<div style="padding: 10px;width: 100%;display: flex;flex-direction: column;">
									...
									<span style="margin-top: 8px;">订单号：{{order_list2.oid}}</span>
									<span style="margin-top: 14px;">{{order_list2.otime}}</span>
								</div>
								<div style="padding: 10px;width: 100%;">
