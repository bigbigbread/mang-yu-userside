	...
	<div style="padding-top: 60px;">
		<div style="height: 50px;background-color: #f2f2f2;">
			<div style="height: 100%;display: flex;align-items: center;margin: 0 auto;width: 90%;">
				<el-page-header style="" @back="goBack" content="商品详情"></el-page-header>
		...
		<div style="margin: 0 auto;width: 90%;padding-top: 12px;display: flex;flex-wrap: wrap;">
			<el-image :src="goods_list.gphoto" :preview-src-list="[goods_list.gphoto]"
				style="width: 100%;height: auto;border-radius: 7px;">
				<div slot="error">
					<img src="../../assets/none.jpg" style="width: 100%;height: auto;border-radius: 7px;" />
				</div>
			</el-image>
			<el-descriptions style="width: 100%;margin-left: 0;" size="medium" class="margin-top"
		...
		<div style="margin: 0 auto;width: 90%;margin-top: 14px;">
			<el-button :disabled="goods_list.gstatus==1?false:true" style="width: 100%;height: 50px;"
		...
		<div style="margin: 0 auto;width: 90%;margin-top: 14px;">
			<div style="padding-top: 110px;padding-bottom: 30px;">
				...
				<el-row :gutter="10" v-for="(item,index) in dataList" :key="index" style="padding-top: 20px">
					...
					<el-col :span="10" style="line-height: 20px;height: 100%;">
						<el-col :span="22">
