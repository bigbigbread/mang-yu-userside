<template>
	<div style="padding-top: 60px;">
		...
		<span style="color: #ff6700;margin: 0 auto;width: 90%;height: 50px;display: flex;align-items: center;justify-content: center;">
			我的购买订单
		</span>
		...
		<div style="margin: 0 auto;width: 90%;margin-top: 14px;margin-bottom: 100px;">
